   ...
   $.fn.validation.defaults = {
    ...
    var validateField = function(field, valid) { 
        ...
        if(form){
            ...
            var iconname = error==false?'icon-ok':'icon-remove';
            if(fstyle == 0){
                controlGroup.find("#valierr").remove();
                el.after('<span class="help-block" id="valierr">' + errorMsg +'</span>');
                if (globalOptions.icon===true ){
                  if (el.find('option').length==0){
                    el.after('<span class="form-control-feedback '+ iconname +' icon-1.5x" aria-hidden="true"></span>');
                  }
                  else{
                    el.after('<span class="form-control-feedback '+ iconname +' icon-1.5x" aria-hidden="true" style="right: 25px;"></span>');  
                  }
              ...
              if (globalOptions.icon===true ){
                ...
                if (globalOptions.icon===true ){
                  if (el.find('option').length==0){
                    el.after('<span class="form-control-feedback '+ iconname +' icon-1.5x" aria-hidden="true" style="right: 25px; top:10px"></span>');
                  }
                  else{
                    el.after('<span class="form-control-feedback '+ iconname +' icon-1.5x" aria-hidden="true" style="right: 25px; top:10px"></span>');  
                  }
